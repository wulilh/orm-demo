...
public class SnowflakeUtils {
   ...
   * #epoch} given by users on {@link SnowflakeUtils} instance initialization.
   */
  ...
  public static void main(String[] args) {
    SnowflakeUtils idWorker = new SnowflakeUtils(1, 2);
    SnowflakeUtils idWorker2 = new SnowflakeUtils(1, 3);
    for (int i = 0; i < 10; i++) {
